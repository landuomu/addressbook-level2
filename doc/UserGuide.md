...
> 
> ADDRESS should be in the following format `a/BLOCK, STREET, UNIT, POSTAL_CODE`
> 
> Persons can have any number of tags (including 0)

Examples: 
* `add John Doe p/98765432 e/johnd@gmail.com a/123, John street, #01-01, 123456`
* `add Betsy Crowe pp/1234567 e/betsycrowe@gmail.com pa/4A, Newgate Prison, #02-03, 999999 t/criminal t/friend`
